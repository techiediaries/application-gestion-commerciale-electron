angular.module('gCom.controller').controller('ListPurchaseJournalController',function ($controller,$scope,$q,dateFilter,DBService,Flash) {
	var base = $controller('ListBaseController', {$scope: $scope,$q:$q,DBService:DBService,Flash:Flash});
	var ctrl = this;
  base.getModel = function(){

  	 	return 'LigneJournalAchat';
  	}
  ...
  base.getInitialPage = function getInitialPage(){
          ...
          DBService.reset();
          DBService.getPurchaseJournalPager(parseInt($scope.pageSize),$scope.startPeriod,$scope.endPeriod).then(function(o){
              base.pager = o;
